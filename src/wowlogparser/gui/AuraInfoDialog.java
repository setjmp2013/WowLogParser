 ...
 * @author racy
 */
public class AuraInfoDialog extends JDialog {

    public AuraInfoDialog(List<BasicEvent> events, double startTime, double stopTime, Frame owner, String title, boolean modal) {
