 ...
 * @author racy
 */
public class FightDamageChartDialog extends JDialog {
    Fight fight;    
    public FightDamageChartDialog(Frame owner, boolean modal, Fight f) {
        super(owner, "Damage distribution - " + f.getName(), modal);
        fight = f;
        JFreeChart chart;
        ...
        for (FightParticipant p : fight.getParticipants()) {
            ...
            dataset.setValue(p.getName(),p.totalDamage(Constants.SCHOOL_ALL, FightParticipant.TYPE_ALL_DAMAGE).amount);
        }
