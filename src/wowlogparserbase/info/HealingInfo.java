 ...
 * @author racy
 */
public abstract class HealingInfo extends InfoBase implements EventsAccessInterface {
    ...
    public abstract double getHealingAverage();
    public abstract double getHps();
    public abstract double getHpsActive();
