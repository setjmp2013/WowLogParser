 ...
 * @author racy
 */
public abstract class DamageInfo extends InfoBase implements EventsAccessInterface {
    ...
    public abstract double getDamageAverage();
    public abstract double getDps();
    public abstract double getDpsActive();
