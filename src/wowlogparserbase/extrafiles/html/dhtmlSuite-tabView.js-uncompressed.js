...
// {{{ __showTab()
	...
	*/	 
	...
	if(refToTabViewObjects[objectIndex].activeTabIndex>=0){ 
		...
		obj.style.backgroundImage='url(\''+DHTMLSuite.configObj.imagePath+'tab-view/tab_left_inactive.png'+'\')'; 
		var imgs=obj.getElementsByTagName('IMG'); 
		var img=imgs[imgs.length-1]; 
		img.src=DHTMLSuite.configObj.imagePath+'tab-view/tab_right_inactive.png'; 
	...
	thisObj.style.backgroundImage='url(\''+DHTMLSuite.configObj.imagePath+'tab-view/tab_left_active.png'+'\')'; 
	var imgs=thisObj.getElementsByTagName('IMG'); 
	var img=imgs[imgs.length-1];	 
	img.src=DHTMLSuite.configObj.imagePath+'tab-view/tab_right_active.png'; 
...
// {{{ rolloverTab()
	...
	*/	 
	...
	if(this.className.indexOf('tabInactive')>=0){ 
		...
		this.style.backgroundImage='url(\''+DHTMLSuite.configObj.imagePath+'tab-view/tab_left_over.png'+'\')'; 
		var imgs=this.getElementsByTagName('IMG'); 
		var img=imgs[imgs.length-1]; 
		 
		img.src=DHTMLSuite.configObj.imagePath+'tab-view/tab_right_over.png'; 
	} 
...
// {{{ rolloutTab()
	...
	*/	 
	...
	if(this.className== 'inactiveTabOver'){ 
		...
		this.style.backgroundImage='url(\''+DHTMLSuite.configObj.imagePath+'tab-view/tab_left_inactive.png'+'\')'; 
		var imgs=this.getElementsByTagName('IMG'); 
		var img=imgs[imgs.length-1]; 
		img.src=DHTMLSuite.configObj.imagePath+'tab-view/tab_right_inactive.png'; 
	}	 
...
// tmpTab titles set to only the new tab 
	...
	for(var no=0;no<tmpTabTitles.length;no++){ 
		...
		aTab.style.backgroundImage='url(\''+DHTMLSuite.configObj.imagePath+'tab-view/tab_left_inactive.png'+'\')'; 
		...
		closeButton.src=DHTMLSuite.configObj.imagePath+'tab-view/tab-view-close.png'; 
...
// {{{ __mouseOutEffectForCloseButton()
	...
	*/
	...
	{ 
	this.src=this.src.replace('close-over.png','close.png');	 
	}	 
...
// {{{ __mouseOverEffectCloseButton()
	...
	*/
	...
	{ 
	this.src=this.src.replace('close.png','close-over.png');	 
	}	 
