 ...
 * @author racy
 */
public class FilterHealingAllSchools extends Filter {
     ...
     * @param school The school to match on(from Constants), or FilterHealingSchool.ANY_SCHOOL to match all schools. If two or more schools are chosen then all those schools must match.
     */
    public FilterHealingAllSchools(int school) {
        this.school = school;
    }
