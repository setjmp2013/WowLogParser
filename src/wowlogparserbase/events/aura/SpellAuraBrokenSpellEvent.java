 ...
 * @author racy
 */
public class SpellAuraBrokenSpellEvent extends SpellAuraBrokenBaseEvent implements SkillInterfaceExtra, AuraTypeInterface {
    private int extraSpellID = -1;
    private String extraSpellName = null;
    private int extraSpellSchool = 0;
    private String auraType = null;

    public SpellAuraBrokenSpellEvent() {
    }
