...
import wowlogparserbase.xmlbindings.fight.SpellAuraDispelledEventXmlType;

/**
 *
 * @author racy
 */
public class SpellAuraDispelledEvent extends SpellAuraBaseEvent implements SkillInterfaceExtra, AuraTypeInterface {
    private int extraSpellID = -1;
    private String extraSpellName = null;
    private int extraSpellSchool = 0;
    private String auraType = null;

    public SpellAuraDispelledEvent() {
    }
    ...
    public void addXmlAttributesBean(Object o) {
        ...
        if (o instanceof SpellAuraDispelledEventXmlType) {
            SpellAuraDispelledEventXmlType o2 = (SpellAuraDispelledEventXmlType) o;
