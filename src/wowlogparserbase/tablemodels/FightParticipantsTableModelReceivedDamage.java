 ...
 * @author racy
 */
public class FightParticipantsTableModelReceivedDamage extends AbstractParticipantsTableModel {

    public final String[] columnNames = {"Name", "Received Damage", "DPS", "Class"};
    ...
    public void setFight(Fight f) {
        ...
        for (k=0; k<participants.size(); k++) {
            FightParticipant fp = participants.get(k).makeReceivedParticipant(f);
