 ...
 * @author racy
 */
public class FightParticipantsTableModelReceivedHealing extends AbstractParticipantsTableModel {

    public final String[] columnNames = {"Name", "Received Healing", "HPS", "Raw Heal", "Overheal%", "Class"};
