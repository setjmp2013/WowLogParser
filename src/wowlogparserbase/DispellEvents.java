 ...
 * @author racy
 */
public class DispellEvents {

    List<SpellAuraDispelledEvent> events = new ArrayList<SpellAuraDispelledEvent>();
    List<String> auraNames = new ArrayList<String>();

    public DispellEvents() {
    }
     ...
     */
    public DispellEvents(List<BasicEvent> events) {
        for (BasicEvent be : events) {
            if (be instanceof SpellAuraDispelledEvent) {
                SpellAuraDispelledEvent e = (SpellAuraDispelledEvent) be;
                addEvent(e);
            }
        }        
    }    
     ...
     * @param e
     */
    public void addEvent(SpellAuraDispelledEvent e) {
        events.add(e);
     ...
     * @return
     */
    public List<SpellAuraDispelledEvent> getEvents(String name) {
        ArrayList<SpellAuraDispelledEvent> retEvents = new ArrayList<SpellAuraDispelledEvent>();
